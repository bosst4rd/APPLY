...
- [x] siehe Screenshot unter \screens\ die dateien lassen sich nicht laden
- [x] ich habe dir unter \Daten JSON mal echte Exports gelegt, woran liegt es dass sich die nicht laden lassen? muss hier bei der erstellung Etwas angepasst werden Oder machen wir hier an diesem Ende einen Fehler?
